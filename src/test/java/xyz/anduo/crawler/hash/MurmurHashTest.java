...
import xyz.anduo.crawler.hash.MurmurHash;
...
public class MurmurHashTest extends TestCase {
  ...
  static final byte[][] input =
      {
          ...
          {(byte) 0x37, (byte) 0xa0, (byte) 0xa9}, {(byte) 0x5b, (byte) 0x5d}, {(byte) 0x7e}, {}};
  ...
  static final int[] results32_standard = {0x96814fb3, 0x485dcaba, 0x331dc4ae, 0xc6a7bf2f,
      0xcdf35de0, 0xd9dec7cc, 0x63a7318a, 0xd0d3c2de, 0x90923aef, 0xaf35c1e2, 0x735377b2,
      0x366c98f3, 0x9c48ee29, 0x0b615790, 0xb4308ac1, 0xec98125a, 0x106e08d9};

  /** Murmur 32bit hash results, special test seed. */
  static final int[] results32_seed = {0xd92e493e, 0x8b50903b, 0xc3372a7b, 0x48f07e9e, 0x8a5e4a6e,
      0x57916df4, 0xa346171f, 0x1e319c86, 0x9e1a03cd, 0x9f973e6c, 0x2d8c77f5, 0xabed8751,
      0x296708b6, 0x24f8078b, 0x111b1553, 0xa7da1996, 0xfe776c70};

  /** Murmur 64bit hash results, default library seed. */
  static final long[] results64_standard = {0x4987cb15118a83d9l, 0x28e2a79e3f0394d9l,
      0x8f4600d786fc5c05l, 0xa09b27fea4b54af3l, 0x25f34447525bfd1el, 0x32fad4c21379c7bfl,
      0x4b30b99a9d931921l, 0x4e5dab004f936cdbl, 0x06825c27bc96cf40l, 0xff4bf2f8a4823905l,
      0x7f7e950c064e6367l, 0x821ade90caaa5889l, 0x6d28c915d791686al, 0x9c32649372163ba2l,
      0xd66ae956c14d5212l, 0x38ed30ee5161200fl, 0x9bfae0a4e613fc3cl,};

  /** Murmur 64bit hash results, special test seed. */
  static final long[] results64_seed = {0x0822b1481a92e97bl, 0xf8a9223fef0822ddl,
      0x4b49e56affae3a89l, 0xc970296e32e1d1c1l, 0xe2f9f88789f1b08fl, 0x2b0459d9b4c10c61l,
      0x377e97ea9197ee89l, 0xd2ccad460751e0e7l, 0xff162ca8d6da8c47l, 0xf12e051405769857l,
      0xdabba41293d5b035l, 0xacf326b0bb690d0el, 0x0617f431bc1a8e04l, 0x15b81f28d576e1b2l,
  ...
  public void testHash32ByteArrayIntInt() {
    for (int i = 0; i < input.length; i++) {
      ...
      if (hash != results32_seed[i])
        fail(String.format("Unexpected hash32 result for example %d: 0x%08x instead of 0x%08x", i,
            hash, results32_seed[i]));
    }
  }
  ...
  public void testHash64ByteArrayIntInt() {
    for (int i = 0; i < input.length; i++) {
      ...
      assertTrue(String.format(
          "Unexpected hash64 result for example %d: 0x%016x instead of 0x%016x", i, hash,
